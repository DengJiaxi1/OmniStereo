...
def evaluate(pred, gt, mask):
    eval_metrics = [mae(pred[mask], gt[mask]),
                    rmse(pred[mask], gt[mask]),
                    absrel(pred[mask], gt[mask]),
                    sqrel(pred[mask], gt[mask]),
                    silog(pred[mask], gt[mask]),
                    delta_acc(1, pred[mask], gt[mask]),
                    delta_acc(2, pred[mask], gt[mask]),
                    delta_acc(3, pred[mask], gt[mask])]
